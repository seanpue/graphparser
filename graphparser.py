...
class GraphParser:
    ...
    def get_onmatch_rules_by_token(self, omr):
        ...
        tokens = self.tokens
        for t,t_classes in list(tokens.items()):
            for o in omr:
                match_rules,prod = o
    ...
    def get_onmatch_rules_token_matrix(self, omr):
        ...
        for t,t_classes in list(self.tokens.items()):
            for o in omr:
                match_rules,prod = o
                curr_class=match_rules[1]
                if curr_class[0] in t_classes:
                    for t2,t2_classes in list(self.tokens.items()):
    ...
    def get_token_match_re_string(self):
        ...
        escaped_tokens = list(map(re.escape, sorted_tokens))
    ...
    def get_sorted_out_edges(self,g):
        ...
        for k,edges in list(out_edges.items()):
